      ...
      <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between flex-wrap gap-4">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          ...
          <button
            ...
            title="Load last month's tasks as a starting template"
          >
          ...
          <button
            onClick={() => onLoad(true)}
            disabled={loading}
            className="px-3 py-1.5 text-sm border border-zinc-300 rounded-md hover:bg-zinc-50 disabled:opacity-50"
            title="Skip loading last month's tasks — useful if you'll import from a spreadsheet"
          >
            Start fresh
          </button>
          <button
